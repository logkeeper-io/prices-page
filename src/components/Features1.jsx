          ...
          <div className="w-full lg:w-1/2 mb-12 lg:mb-0">
            <div className="mx-auto lg:mx-auto w-11/12 sm:w-4/5 md:w-3/4 lg:w-unset">
              ...
              <h2 className="mt-6 mb-8 text-4xl lg:text-5xl block-big-title">
                Unlike any tool you've experienced before.
              </h2>
              <p className="mb-10 text-secondaryText leading-loose">
                Unlock powerful insights from your data with our innovative, user-friendly platform.
                Transform complex logs into actionable analytics to drive your business forward.
              </p>
              <ul className="mb-6 text-primaryText">
                ...
                <li className="mb-4 flex">
                  <CheckArrowIcon />
                  <span>Dynamic log aggregation and analysis</span>
                </li>
                <li className="mb-4 flex">
                  <CheckArrowIcon />
